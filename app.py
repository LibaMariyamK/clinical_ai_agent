...
# ── App identity — change here to rename everywhere ───────────────────────────
APP_NAME = "ClinixAI"
APP_ICON = "🩺"
# ─────────────────────────────────────────────────────────────────────────────
...
/* ── SIDEBAR — keep new structure, dark palette ── */
...
/* All text inside chat — bright and readable on dark background */
...
with st.sidebar:
    ...
    <div class="sb-footer">
        ...
        Vision · <span>Llama 4 Maverick 17B</span><br>
...
for message in st.session_state.messages:
    ...
    with st.chat_message(message["role"], avatar=avatar):
        ...
        if "source" in message:
            src = message["source"]
            if src == "WEB":
                st.caption("🌐  Web Search — external source")
            else:
                st.caption("📄  Knowledge Base — Gale Encyclopedia of Medicine")
